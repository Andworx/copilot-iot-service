...
Initial staged design for [#206](https://github.com/Andworx/copilot-iot-service/issues/206):

- [Architecture and decisions](network-architecture.md)
- [Router VPN POC](vpn-setup.md)
