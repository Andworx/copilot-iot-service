...
| `DATAVERSE_URL` | Dataverse environment URL e.g. `https://YOUR_ORG_NAME.crm.dynamics.com` — set as an App Setting (see Dataverse Auth below) |
...
az functionapp config appsettings set \
  ...
  --settings DATAVERSE_URL=https://YOUR_ORG_NAME.crm.dynamics.com
```
...
```json
{
  "IsEncrypted": false,
  "Values": {
    "DATAVERSE_URL": "https://YOUR_ORG_NAME.crm.dynamics.com",
    ...
  }
}
```
...
curl -H "Authorization: Bearer <token>" \
  "https://YOUR_ORG_NAME.crm.dynamics.com/api/data/v9.2/andy_iottelemetryevents?\$top=5&\$orderby=createdon desc"
```
